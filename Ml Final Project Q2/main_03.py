...
file_path = 'arcgis_ngas_usak_v02.csv' 
df = pd.read_csv(file_path)

categorical_cols = ["Year"]
numeric_cols = list(df.columns[1:15])
...
# Preprocess the data
df_preprocessed = preprocessor.fit_transform(sampled_data)
...
eps_value = 1  # Replace with the chosen value from the plot
